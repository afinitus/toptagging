...
if __name__=='__main__':
    ...
    parser.add_option("--folder", type="string", default='/Users/nishankgite/Desktop/research/data/TOPTAGGING', help="Folder containing input files")
